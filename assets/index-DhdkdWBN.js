      ...
      ${f({state:M})}
        ...
        <div class="mb-6">
          ...
          ${M.productLoading?``:`<div class="mb-4 text-sm text-gray-600">
            ...
            <!-- 상품 그리드 -->
            ${v({children:`
              ${(M.products??[]).length>0?`${M.products.map(e=>p(e)).join(``)}`:_.repeat(4)}
              `})}
